 ...
 * Option callbacks
 */
$GLOBALS['TL_LANG']['tl_parallax']['js']['fadeIn']     = array('Element einfaden');
$GLOBALS['TL_LANG']['tl_parallax']['js']['fadeOut']    = array('Element ausfaden');
$GLOBALS['TL_LANG']['tl_parallax']['js']['fadeSlowIn'] = array('Element langsam einfaden');